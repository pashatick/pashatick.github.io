...
### **UC 3.1.1 UC Регистрация пользователя** <a  name="UC3.1.1UCРегистрацияпользователя"></a>
*Опсиание UC*
...
### **UC 3.1.2 UC Поиск животного по параметрам** <a  name="UC3.1.2UCПриобретениеживотного"></a>
...
### **UC 3.1.3 UC Оформление покупки** <a  name="UC3.1.3.Приобретениеживотного"></a>
...
### **UC 3.1.4 UC Оформление возврата** <a  name="UC 3.1.4.UCОформлениевозврата"></a>
