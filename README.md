...
<div class="alert alert-block alert-warning"> <b>!!!</b> Предаставленные на схеме API методы не реализованы в полном объеме </div>
...
<div class="alert alert-block alert-warning">!!!! Представленные API могут быть реализованы одним методом, данны вариант может быть актуален для уменьшиния числа полей заполения при редактировании данных (*например*: изменение только веса жиотных или только вальра содержания)</div>
