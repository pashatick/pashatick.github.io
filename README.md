...
| :-: | :- |
|**Name**|ElephantFarm|
|**Сreator**|Гобелков П.В. [резюме](/docs/PavelsRes.pdf)|
...
**Диагарамма прецедентов**

![](/uml/DPricident.drawio.png)
...
### **2.5. Модель базы данных** <a  name="4.Модельбазыданных"></a>
**Краткое описание**
...
### **2.6. Архитектура проекта** <a  name="7.Архитектурапроекта"></a>

Система придставлена двумя сервисами

> Сервис контроля и учета животных (**Animals control service (AnimalsControl)**) - описывает качественные и количественные признаки животых, осблуживащий персонал, места содержания.

> Сервис разадчи/возврата/обмена животных (**Distribution service (DistSystem)**) - описывает точки раздачи/приема животных, аккаунт клинента фермы, формы заказаов
...
|[Реализовать метод расчета жизненого пространства для выбора подходящего вальера](https://pashatick.atlassian.net/browse/EL-10)||
|||
...
|[Реализовать метод проверки соответствия животного товарным нормам](https://pashatick.atlassian.net/browse/EL-10)||
|||
